    ...
    <div className="p-6 space-y-6">
      ...
      >
        ...
        <p className="text-gray-600">
          Generate comprehensive, FDA 21 CFR 210/211 compliant deviation investigation reports
        </p>
      </motion.div>
            ...
            <div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  <label key={format.value} className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <input
                      type="radio"
                      name="format"
                      value={format.value}
